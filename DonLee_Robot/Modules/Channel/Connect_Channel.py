# (C) cranged from AlbertEinstein_TG
...
async def connect(bot: DonLee_Robot, update):
    ...
    try:
        ...
        await update.reply_text("Encountered Some Issue..Please Check Logs..❗️❗️")
        raise e
